...
export function Footer() {
  return (
    <footer className="mt-36 border-t bg-white dark:border-gray-700/60 dark:bg-black">
      <div className="mx-auto max-w-5xl px-6">
        <div className="flex flex-col items-baseline gap-y-16 py-12 md:grid md:grid-cols-12 md:gap-8">
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 16 16"
                      focusable="false"
                      className="h-5 w-5 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300"
                    >
          ...
          <div className="md:col-span-3 md:col-start-6">
            <Heading level={2} className="font-sans font-normal">
              Resources
            </Heading>
            <nav>
          ...
          <div className="text-sm leading-loose tracking-wide md:col-span-4 md:col-start-9">
