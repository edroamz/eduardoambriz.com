  ...
  return (
    ...
    >
      <path
        ...
        className={cn(
          selected
            ? 'fill-sky-400/20 stroke-primary-dark'
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path
        ...
        className={cn(
          selected ? 'fill-primary-dark' : 'fill-slate-400 dark:fill-slate-500',
          props.className
        )}
      />
      <path
  ...
  return (
    <DropdownMenu dir="ltr" modal={false}>
      ...
      <DropdownMenuTrigger id="btn-theme">
        <MoonIcon className="hidden h-6 w-6 hover:text-gray-800 dark:inline"></MoonIcon>
        <SunIcon className="inline h-6 w-6 hover:text-gray-800 dark:hidden"></SunIcon>
      </DropdownMenuTrigger>
      <DropdownMenuPortal>
        <DropdownMenuContent
          className={cn(
